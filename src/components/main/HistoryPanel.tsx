...
export function HistoryPanel({ historyRows, operatorName }: HistoryPanelProps) {
  return (
    <section className="flex min-h-0 flex-col rounded-2xl border border-zinc-800 bg-zinc-900 p-5 shadow-2xl">
      ...
      <div className="min-h-[565px] overflow-auto rounded-xl border border-zinc-800 bg-zinc-950">
